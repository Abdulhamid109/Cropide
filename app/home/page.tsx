...
const Page = () => {
  ...
  return (
    <div className='relative h-screen w-screen overflow-auto'>
      ...
      {/* <div className='inset-0 w-screen h-screen fixed absolute backdrop-blur-lg bg-black/40'></div> */}
      <Navbar2 />
      <section className='absolute top-[15vh]'>
        <div className='flex flex-col justify-center items-center'>
          <div className='w-screen text-center text-xl p-7'>Welcome {loading ? "loading..." : name},</div>
          ...
          <div className='relative top-[23vh] flex flex-col justify-center items-center text-xs'>
